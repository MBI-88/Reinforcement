...
class Piliticy_Garadient():
    ...
    def build_model(self):
        ...
        self.logp_model.compile(optimizer=optimizer,loss=loss)
    ...
    def saved_weight(self):
        self.actor.save_weights('Model_Weight.h5')
        self.encoder.save_weights('Encoder_Weight.h5')

    def load_weight(self):
        self.actor.load_weights('Model_Weight.h5')
...
class Reinforcement_Agent(Piliticy_Garadient):
    def __init__(self,env):
        super().__init__(env)
    ...
    def train(self,item,gamma=1.0):
        ...
        history=self.logp_model.fit(np.array(state),discounted_delta,batch_size=1,epochs=1,verbose=0)
...
agent=Reinforcement_Agent(env=env)
